...
/** 请求任务 */
typedef NSURLSessionTask WSFURLSessionTask;

#pragma mark - 网络数据请求类

@interface WSFHTTPSessionManager : NSObject
 ...
 *  @return 返回的对象可取消请求,调用cancle方法
 */
+ (WSFURLSessionTask *)GET:(NSString *)URL parameters:(NSDictionary *)parameters responseCache:(HttpRequestCache)responseCache progress:(HttpProgress)progress success:(HttpRequestSuccess)success failure:(HttpRequestFailed)failure;
 ...
 *  @return 返回的对象可取消请求,调用cancle方法
 */
+ (WSFURLSessionTask *)POST:(NSString *)URL parameters:(NSDictionary *)parameters responseCache:(HttpRequestCache)responseCache progress:(HttpProgress)progress success:(HttpRequestSuccess)success failure:(HttpRequestFailed)failure;
/*!
 *  网络请求的实例方法
 *
 ...
 */
+ (WSFURLSessionTask *)downloadWithURL:(NSString *)URL fileDir:(NSString *)fileDir progress:(HttpProgress)progress success:(void(^)(NSString *filePath))success failure:(HttpRequestFailed)failure;

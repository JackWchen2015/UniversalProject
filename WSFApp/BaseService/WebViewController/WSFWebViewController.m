...
@interface WSFWebViewController ()<WKNavigationDelegate>
@property (nonatomic,strong) WSFJSHandler * jsHandler;
@property (nonatomic,assign) double lastProgress;//上次进度条位置

@end

@implementation WSFWebViewController
...
-(void)initWKWebView
{
    ...
    _jsHandler = [[WSFJSHandler alloc]initWithViewController:self configuration:configuration];
